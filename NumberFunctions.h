...
void insertNumber(T &value, bool &error){//è questa che viene chiamata. Così risparmia la riscrittura continua del ciclo in essa contenuto. Basta solo dichiarare un flag fuori dalla funzione
    do{
        cin>>value;
        verifyNumber(error);
